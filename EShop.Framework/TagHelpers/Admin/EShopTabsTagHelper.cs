...
{
    /// <summary>
    /// "EShop-tabs" tag helper
    /// </summary>
    [HtmlTargetElement("eshop-tabs", Attributes = ID_ATTRIBUTE_NAME)]
    public class EShopTabsTagHelper : TagHelper
    {
        #region Constants
        ...
        public EShopTabsTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //create context item
            var tabContext = new List<EShopTabContextItem>();
            context.Items.Add(typeof(EShopTabsTagHelper), tabContext);
    ...
    /// <summary>
    /// "EShop-tab" tag helper
    /// </summary>
    [HtmlTargetElement("eshop-tab", ParentTag = "eshop-tabs", Attributes = NAME_ATTRIBUTE_NAME)]
    public class EShopTabTagHelper : TagHelper
    {
        #region Constants
        ...
        public EShopTabTagHelper(IHtmlHelper htmlHelper)
        {
            _htmlHelper = htmlHelper;
        }
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //add to context
            var tabContext = (List<EShopTabContextItem>)context.Items[typeof(EShopTabsTagHelper)];
            tabContext.Add(new EShopTabContextItem
            {
    ...
    /// Tab context item
    /// </summary>
    public class EShopTabContextItem
    {
        /// <summary>
        /// Title
        /// </summary>
