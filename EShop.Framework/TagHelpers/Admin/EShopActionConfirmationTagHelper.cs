...
{
    /// <summary>
    /// "EShop-action-confirmation" tag helper
    /// </summary>
    [HtmlTargetElement("eshop-action-confirmation", Attributes = BUTTON_ID_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public class EShopActionConfirmationTagHelper : TagHelper
    {
        #region Constants
        ...
        public EShopActionConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
