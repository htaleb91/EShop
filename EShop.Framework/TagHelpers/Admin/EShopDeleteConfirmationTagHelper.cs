...
{
    /// <summary>
    /// "EShop-delete-confirmation" tag helper
    /// </summary>
    [HtmlTargetElement("eshop-delete-confirmation", Attributes = MODEL_ID_ATTRIBUTE_NAME + "," + BUTTON_ID_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
    public class EShopDeleteConfirmationTagHelper : TagHelper
    {
        #region Constants
        ...
        public EShopDeleteConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
