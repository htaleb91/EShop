...
{
    /// <summary>
    /// "EShop-card" tag helper
    /// </summary>
    [HtmlTargetElement("eshop-card", Attributes = NAME_ATTRIBUTE_NAME)]
    public class EShopCardTagHelper : TagHelper
    {
        #region Constants
        ...
        public EShopCardTagHelper(IHtmlHelper htmlHelper)
        {
