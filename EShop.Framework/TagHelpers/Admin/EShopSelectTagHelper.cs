...
namespace EShop.Framework.TagHelpers.Admin
{
    ...
    /// </summary>
    [HtmlTargetElement("eshop-select", TagStructure = TagStructure.WithoutEndTag)]
    public class EShopSelectTagHelper : TagHelper
    {
        #region Constants
        ...
        public EShopSelectTagHelper(IHtmlHelper htmlHelper)
        {
