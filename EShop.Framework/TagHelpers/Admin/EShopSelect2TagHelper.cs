...
{
    /// <summary>
    /// "EShop-select" tag helper
    /// </summary>
    [HtmlTargetElement("eshop-multi-select", TagStructure = TagStructure.WithoutEndTag)]
    public class EShopSelect2TagHelper : TagHelper
    {
        #region Constants
        ...
        public EShopSelect2TagHelper(IHtmlHelper htmlHelper)
        {
