...
{
    /// <summary>
    /// "EShop-textarea" tag helper
    /// </summary>
    [HtmlTargetElement("eshop-textarea", Attributes = FOR_ATTRIBUTE_NAME)]
    public class EShopTextAreaTagHelper : TextAreaTagHelper
    {
        #region Constants
        ...
        public EShopTextAreaTagHelper(IHtmlGenerator generator) : base(generator)
        {
        }
