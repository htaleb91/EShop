...
{
    /// <summary>
    /// "EShop-alert" tag helper
    /// </summary>
    [HtmlTargetElement("eshop-alert", Attributes = ALERT_NAME_ID, TagStructure = TagStructure.WithoutEndTag)]
    public class EShopAlertTagHelper : TagHelper
    {
        #region Constants
        ...
        public EShopAlertTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
